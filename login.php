    ...
    <div class="box-form">
        <div class="left">
            <div class="overlay">
                ...
                <span>
                    <a href="registration.php"><i class="redirect-register" aria-hidden="true"></i>Register</a>
                </span>
            </div>
        </div>
        ...
        <div class="right">
            <h5>Login</h5>
            <p>We're glad to see you back! Log in and continue your journey with us.</p>
            <div class="inputs">
                <form action="login.php" method="post">
                    ...
                    <button title="Log In" type="submit" class="sign-in_btn" name="login">
                        <span>Login</span>
                    </button>
                </form>
                <div>
