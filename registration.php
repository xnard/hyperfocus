        ...
        <div class="box-form">
            <div class="left">
                <div class="overlay">
                    ...
                    <span>
                        <a href="login.php"><i class="redirect-login" aria-hidden="true"></i>Login</a>
                    </span>
                </div>
            </div>
                ...
                <div class="inputs">
                    <form action="registration.php" method="post">
                        ...
                        <div class="input_container">
                            ...
                            <img class="person-icon" src="images/person-icon.png">
                            <input placeholder="Full Name" title="Input name" name="fullname" type="text"
                                class="input_field" id="name_field">
                        ...
                        <div class="input_container">
                            ...
                            <input placeholder="name@mail.com" title="Input email" name="email" type="email"
                        ...
                        <div class="input_container">
                            ...
                            <input placeholder="Password" title="Input password" name="password" type="password"
                        ...
                        <div class="input_container">
                            ...
                            <input placeholder="Repeat Password" title="Input password" name="repeat_password"
                                type="password" class="input_field" id="password_field">
                        </div>
                        <button title="Sign Up" type="submit" class="sign-in_btn" name="submit">
                            <span>Register</span>
                        </button>
                    </form>
                    <div>
